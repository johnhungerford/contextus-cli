...
object SefariaIndexEntryTest extends ZIOSpecDefault:
	...
	val complexEntry = SefariaIndexEntry(
		...
		List("The Gilded Age"),
		List("The Gilded Age hebrew"),
		Left(SefariaSchemaNode.Section(
			title = "Test submission",
			heTitle = "Test submission HEBREW",
			titles = List(SefariaTitle("Test submission", "en", Some(true)), SefariaTitle("Test submission HEBREW", "he", Some(true))),
			key = "Test submission",
			nodes = List(
